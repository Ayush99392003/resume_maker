...
% fontawesome
% fontawesome5 disabled (Tectonic compat)

% fixed width
% FiraMono disabled (Tectonic compat)
...
% custom underilne
% contour disabled (Tectonic compat)
...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Ayush Agarwal} \\ \vspace{5pt}
    \small Tel \texttt{555.555.5555} \hspace{1pt} $|$ 
    \hspace{1pt} Email \hspace{2pt} \texttt{hello@email.com} \hspace{1pt} $|$ 
    \hspace{1pt} YT \hspace{2pt} \texttt{harshibar} \hspace{1pt} $|$ 
    \hspace{1pt} Loc \hspace{2pt}\texttt{U.S. Citizen}
    \\ \vspace{-3pt}
\end{center}
% ZONE:1:END
% ZONE:2:START
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Creator (\href{https://www.youtube.com/c/ayushagarwal}{\myuline {@ayushagarwal}})}{San Francisco, CA}
      \resumeItemListStart
        ...
        \resumeItem{Conducted A/B testing on titles and thumbnails; \textbf{increased video impressions by 2.5M} in 3 months}
         \resumeItem{Designed a {\href{https://www.notion.so/ayushagarwal/dfab8b6d935a479fa699312174fea8af?v=e64d99d35b8447aab0a749c0c790f3d7}{\myuline {Notion workflow}}} to streamline video production and roadmapping; boosted productivity by 20\%}
...
section{PROJECTS}
          ...
          {	extbf{Hyku Consulting}} {Sept. 2019 -- Mar. 2021}
            ...
            esumeItem{Mentored 15 students towards acceptance at top US boarding schools; achieved \textbf{100\% success rate}}
            esumeItem{Designed a collaborative learning ecosystem for students and parents with Trello, Miro, and Google Suite}
            esumeItem{Expanded customer outreach through {\href{https://www.quora.com/profile/Ayush-Agarwal}{{\myuline{Quora}}}} (1M+ views); reached \textbf{$\25k total revenue} in 2 years}
          esumeItemListEnd
          
        esumeProjectHeading
          {	extbf{Minimal Icon Pack}}{Sept. 2020 -- Nov. 2020}
          esumeItemListStart
            esumeItem{Designed and released 100+ minimal iOS and Android icons from scratch using Procreate and Figma}
            esumeItem{Marketed the product and design process on {\href{https://www.youtube.com/watch?v=Ju32r7QJCzk}{\myuline {YouTube}}}; accumulated over \textbf{$\250 in sales} on {\href{https://gumroad.com/l/icons-by-ayush-agarwal}{\myuline {Gumroad}}}}
          esumeItemListEnd
          
      esumeProjectHeading
         {	extbf{CommonIntern}}{Sept. 2019 -- May 2020}
          esumeItemListStart
            esumeItem{Built a Python script to automatically apply to jobs on Glassdoor using BeautifulSoup and Selenium}
            esumeItem{\textbf{500 stars on \href{https://github.com/ayush-agarwal/common-intern}{\myuline {GitHub}}}; featured on {\href{https://hackaday.com/2020/05/30/job-application-script-automates-the-boring-stuff-with-python}{\myuline {Hackaday}}}; made the front page of {\href {https://www.reddit.com/r/Python/comments/gpaegj/i_was_tired_of_opening_100s_of_tabs_for/?utm_source=share}{\myuline {r/python}}} and {\href {https://www.reddit.com/r/programming/comments/dcmbzx/i_was_tired_of_opening_100s_of_tabs_for/}{\myuline {r/programming}}}}
